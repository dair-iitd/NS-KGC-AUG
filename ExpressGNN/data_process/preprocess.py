...
def preprocess_large(dataroot):
    ...
    # fact_path_ls = [joinpath(dataroot, 'facts_rev.txt'),
    #                joinpath(dataroot, 'train_rev.txt')]
    fact_path_ls = [joinpath(dataroot, 'train.txt')]
    ...
    #print(fact_path_ls)
    #print(f"fact_path_ls: {fact_path_ls} query_path = {query_path} pred_path:{pred_path}  const_path:{const_path} valid_path: {valid_path} rule_path:{rule_path}")
