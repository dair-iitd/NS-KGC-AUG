...
def main(args):
    ...
    for k in range(cfg.EM.num_iters):
        ...
        valid_mrr_iter, _ = solver_p.evaluate('valid', expectation=cfg.predictor.eval.expectation)
        test_mrr_iter, _ = solver_p.evaluate('test', expectation=cfg.predictor.eval.expectation)
    ...
    for k in range(cfg.final_prediction.num_iters):
        ...
        valid_mrr_iter, _ = solver_p.evaluate('valid', expectation=cfg.predictorplus.eval.expectation)
        test_mrr_iter, _ = solver_p.evaluate('test', expectation=cfg.predictorplus.eval.expectation)
