...
from predictors_rotate import PredictorPlus
...
def main(args):
    ...
    for k in range(cfg.num_iters):
        ...
        valid_mrr_iter, _ = solver.evaluate('valid', expectation=cfg.predictor.eval.expectation)
        test_mrr_iter, _ = solver.evaluate('test', expectation=cfg.predictor.eval.expectation)
